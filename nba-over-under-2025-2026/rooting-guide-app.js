...
h+=’<div><div style="font-size:11px;font-weight:700;color:var(--t2);margin-bottom:6px">’+sn(home)+’ (’+hT.w+’-’+hT.l+’) · Target: ‘+hT.wp+’</div>’;
h+=’<div style="font-size:10px;color:var(--t3);margin-bottom:6px">Wins to go over: ‘+(hT.wtg!==null?hT.wtg:’-’)+’ · Losses to go under: ‘+(hT.ltg!==null?hT.ltg:’-’)+hClinch+’</div>’;
...
h+=’<div><div style="font-size:11px;font-weight:700;color:var(--t2);margin-bottom:6px">’+sn(away)+’ (’+aT.w+’-’+aT.l+’) · Target: ‘+aT.wp+’</div>’;
h+=’<div style="font-size:10px;color:var(--t3);margin-bottom:6px">Wins to go over: ‘+(aT.wtg!==null?aT.wtg:’-’)+’ · Losses to go under: ‘+(aT.ltg!==null?aT.ltg:’-’)+aClinch+’</div>’;
