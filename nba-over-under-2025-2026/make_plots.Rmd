...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path('../docs/2026-nba-over-under.html')) })
---
...
`Win Projection` was pulled from prior to the season start. The last two
