...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            over_under_choice("Hawks", choices = "OVER"),
            over_under_choice("Celtics", choices = "UNDER"),
            over_under_choice("Nets", choices = "OVER"),
            ...
            over_under_choice("Clippers", choices = "OVER"),
