...
- Fork homework repo
- `clone` repository from your GitHub account in RStudio as RStudio project
- Make a change to a file
- Check the box next to the files to `add`
- Commit the changes
- `push` the changes to GitHub via
- Every time you start over you should click the Pull button
...
<img src="img/github.jpg" width="200"/> <img src="img/plus.jpg" width="50"/> <img src="img/rstudio.png" width="200"/>
