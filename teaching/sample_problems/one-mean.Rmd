...
library(dplyr)
library(knitr)
download.file("https://raw.githubusercontent.com/ismayc/ismayc.github.io/master/teaching/sample_problems/ageAtMar.csv", destfile = "ageAtMar.csv")
...
**Interpretation**:  We are 95% confident the true mean age of first marriage for all US women from 2006 to 2010 is between `r boot_distn$lower` and `r boot_distn$upper`.
---
