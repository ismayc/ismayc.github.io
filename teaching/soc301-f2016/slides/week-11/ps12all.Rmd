...
- A. Parameters are calculations based on a sample, statistics are calculations based on the population  
- B. Statistics are calculations based on a sample, parameters are calculations based on statistics
- C. Parameters are measured from the population
- D. Both B and C 
...
In order to complete the task of creating a simulation where you flip a coin 500 times in sets of 10, what would be the necessary functions to input?
