...
- Re-read Chapter 5 and create five of your own problems (in partners if you like) using the `gap` data frame you downloaded for Exam 1.  Save this file as `ps9.Rmd` in your `LastnameFirstname` folder.
