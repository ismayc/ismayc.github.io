...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    {\color{red} Sample survey.  Unethical to apply treatment}
    
    \item Do college students learn basic accounting better in a classroom or using an online course?
    
    {\color{red} Experiment.  Can apply treatments randomly---hopefully}
    
    \item How long do your teachers wait, on average, after they ask their class a question for students to respond?

    {\color{red} Non-sample observational study.  Doesn't make sense to survey and teachers may be ethically opposed.}
...
\begin{itemize}
  ...
  \item What are the treatments being compared?
    ...
    {\color{red} Alone with thief, in pairs with thief}
    
  \item What is the explanatory variable?
  
    {\color{red} Whether the subject is alone or in pairs with thief}  

  \item What is the response variable?
  
      {\color{red} Whether or not subject reports theft}
  
  \item Do you think this study is ethically OK? Why or why not?
  
      {\color{red} Not necessarily.  Thievery could have a traumatic experience on subjects.}
...
\begin{enumerate}
  \item There are 3 explanatory variables (light, noise, gender) and 1 response variable (exam performance)
    \item {\color{red} There are 2 explanatory vars (light and noise), 1 blocking var}       
