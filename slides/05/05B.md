...
- Out of the 10,000 simulations, 263 were greater than 0.2916667.

- Therefore, $p$-value = 0.0263.  Since this is smaller than $\alpha = 0.05$, we reject $H_0$ and based on this data, we have evidence that females are unfairly discriminated against in terms of promotions.
