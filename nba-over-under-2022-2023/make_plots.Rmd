---
title: 'NBA Over/Under 2022-2023 Season'
author: Created by Chester Ismay
output: html_document
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path('../2023-nba-over-under.html')) })
---
...
### By week (Skipped until Week 2)

This plot is updated on Monday each week with the previous week's results.

```{r fig.height=10, fig.width=10, message=FALSE, warning=FALSE, eval=FALSE}
...
Note that the *Current Wins* column is currently not populating due to https://data.nba.net not having updated since October 12, 2022.
...
picks_wide <- picks %>% 
  ...
  select(Team = team, `Current Wins` = wins, `Target Wins`, 
         Adonis, Andy, Chester, Jake, Jenelle, Mary, Mike, Phil, Ryan, 
         everything())
